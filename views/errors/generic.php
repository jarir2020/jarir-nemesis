...
<head>
    ...
    <title><?= isset($code) ? (int)$code : 'Error' ?> — Something Went Wrong</title>
    <style>
...
<body>
    <div class="card">
        <div class="code"><?= isset($code) ? (int)$code : '?' ?></div>
        <h1>Something Went Wrong</h1>
        <p><?= isset($message) ? htmlspecialchars($message, ENT_QUOTES) : 'An unexpected error occurred. Please try again.' ?></p>
        <a href="/">Go Home</a>
    </div>
</body>
</html>
